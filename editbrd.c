  ...
  for(emode=numprefix=0;;) {
    ...
    switch(emode) {
      ...
      case 'w': case 'W': switch(k) {
        ...
        case 'e': if(board_info.exits[DIR_E]) { xcur2=brd_id; switch_to_board(board_info.exits[DIR_E]); } break;
        case 'E': if(xcur2) board_info.exits[DIR_E]=xcur2; break;
        case 'm': xcur2=brd_id; break;
        case 'M': xcur2=numprefix; numprefix=0; break;
        case 'n': if(board_info.exits[DIR_N]) { xcur2=brd_id; switch_to_board(board_info.exits[DIR_N]); } break;
        case 'N': if(xcur2) board_info.exits[DIR_N]=xcur2; break;
        case 'q': ycur2=xcur2; xcur2=brd_id; switch_to_board(ycur2); break;
        case 's': if(board_info.exits[DIR_S]) { xcur2=brd_id; switch_to_board(board_info.exits[DIR_S]); } break;
