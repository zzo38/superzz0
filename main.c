#if 0
gcc -s -O2 -o ~/bin/superzz0 -Wno-unused-result main.c audio.o display.o edit.o editbrd.o editscr.o edittext.o game.o lumped.o printer.o window.o world.o -lm `sdl-config --cflags --libs`
exit
#endif
