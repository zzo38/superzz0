#if 0
gcc $CFLAGS -o ~/bin/superzz0 -Wno-unused-result main.c asn1.o audio.o display.o edit.o editbrd.o editscr.o edittext.o game.o lumped.o printer.o resample.o savegame.o slice.o special.o window.o world.o -lm `sdl-config --cflags --libs`
exit
#endif
